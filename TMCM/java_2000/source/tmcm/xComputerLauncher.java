...
public class xComputerLauncher extends Applet {

   private xComputerFrame frame;
   ...
   public String getAppletInfo() {
      return "xComputerLauncher, by David J. Eck (eck@hws.edu), July 1997";
   }
   ...
   public void init() {
      ...
      launchButton = new Button("Launch xComputer");
   ...
   private void launch() {
     if (frame != null) {
        if (frame.isClosed())
           frame = new xComputerFrame(urls,nameList);
        else
           frame.show();
     }
     else {
